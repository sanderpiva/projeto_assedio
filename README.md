Este estudo investiga o assédio sexual no ambiente acadêmico, abordando-o como uma manifestação de abuso de poder e superioridade.
...
A base de dados original não foi aplicada nesse projeto, todavia, a base de dados substituta empregada é sobre violência e crimes em geral 
oriunda da Secretaria de Segurança do Estado de Minas Gerais.
